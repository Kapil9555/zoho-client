...
import { MoreVertical, ArrowUpRight, ArrowDownRight, CheckCircle, XCircle, IndianRupee, Target, TrendingUp, Trophy } from "lucide-react";
import {
            ...
            <div className="mt-8 space-y-6 text-center">
                <div>
                    <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
                        <Target color={THEME} /><span>{outerLabel}</span>
                    </div>
                ...
                <div>
                    <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
                        <Dot color={THEME} /><span>Total Sales</span>
                    </div>
                ...
                <div>
                    <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
                        <Dot color={THEME_600} /><span>{innerLabel}</span>
                    </div>
...
export default function DashboardOverview() {
    ...
    // %s
    const profitVsSalesPct = useMemo(() => pct(profitSum, invoiceSum), [profitSum, invoiceSum]);
